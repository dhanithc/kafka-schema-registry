...
public class Device extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -117767657568746962L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Device\",\"namespace\":\"com.dc.kafka.avro.audio\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"location\",\"type\":\"string\"},{\"name\":\"level\",\"type\":\"int\",\"default\":8}]}");
   ...
   */
  public static com.dc.kafka.avro.audio.Device.Builder newBuilder() {
    return new com.dc.kafka.avro.audio.Device.Builder();
  }
   ...
   * @return A new Device RecordBuilder
   */
  public static com.dc.kafka.avro.audio.Device.Builder newBuilder(com.dc.kafka.avro.audio.Device.Builder other) {
    if (other == null) {
      return new com.dc.kafka.avro.audio.Device.Builder();
    } else {
      return new com.dc.kafka.avro.audio.Device.Builder(other);
    }
  }
   ...
   * @return A new Device RecordBuilder
   */
  public static com.dc.kafka.avro.audio.Device.Builder newBuilder(com.dc.kafka.avro.audio.Device other) {
    if (other == null) {
      return new com.dc.kafka.avro.audio.Device.Builder();
    } else {
      return new com.dc.kafka.avro.audio.Device.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Device>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dc.kafka.avro.audio.Device.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dc.kafka.avro.audio.Device other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder setLocation(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder clearLocation() {
      location = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder setLevel(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.audio.Device.Builder clearLevel() {
