...
public class AudioCommand extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7901326515501189497L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AudioCommand\",\"namespace\":\"com.dc.kafka.avro\",\"fields\":[{\"name\":\"command\",\"type\":\"string\"}]}");
   ...
   */
  public static com.dc.kafka.avro.AudioCommand.Builder newBuilder() {
    return new com.dc.kafka.avro.AudioCommand.Builder();
  }
   ...
   * @return A new AudioCommand RecordBuilder
   */
  public static com.dc.kafka.avro.AudioCommand.Builder newBuilder(com.dc.kafka.avro.AudioCommand.Builder other) {
    if (other == null) {
      return new com.dc.kafka.avro.AudioCommand.Builder();
    } else {
      return new com.dc.kafka.avro.AudioCommand.Builder(other);
    }
  }
   ...
   * @return A new AudioCommand RecordBuilder
   */
  public static com.dc.kafka.avro.AudioCommand.Builder newBuilder(com.dc.kafka.avro.AudioCommand other) {
    if (other == null) {
      return new com.dc.kafka.avro.AudioCommand.Builder();
    } else {
      return new com.dc.kafka.avro.AudioCommand.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AudioCommand>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.dc.kafka.avro.AudioCommand.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.dc.kafka.avro.AudioCommand other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.command)) {
        this.command = data().deepCopy(fields()[0].schema(), other.command);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.AudioCommand.Builder setCommand(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.dc.kafka.avro.AudioCommand.Builder clearCommand() {
      command = null;
