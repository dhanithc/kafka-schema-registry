...
public class PlaySong extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PlaySong\",\"namespace\":\"com.dc.kafka.avro.audio\",\"fields\":[{\"name\":\"song\",\"type\":\"string\"},{\"name\":\"artist\",\"type\":\"string\"},{\"name\":\"action\",\"type\":{\"type\":\"enum\",\"name\":\"Action\",\"symbols\":[\"PLAY\",\"STOP\",\"PAUSE\",\"RESUME\"]}}]}");
   ...
   */
  public PlaySong(java.lang.CharSequence song, java.lang.CharSequence artist, Action action) {
    this.song = song;
    this.artist = artist;
    this.action = action;
  }
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: action = (Action)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static PlaySong.Builder newBuilder() {
    return new PlaySong.Builder();
  }
   ...
   * @return A new PlaySong RecordBuilder
   */
  public static PlaySong.Builder newBuilder(PlaySong.Builder other) {
    if (other == null) {
      return new PlaySong.Builder();
    } else {
      return new PlaySong.Builder(other);
    }
  }
   ...
   * @return A new PlaySong RecordBuilder
   */
  public static PlaySong.Builder newBuilder(PlaySong other) {
    if (other == null) {
      return new PlaySong.Builder();
    } else {
      return new PlaySong.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PlaySong>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(PlaySong.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(PlaySong other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.song)) {
        this.song = data().deepCopy(fields()[0].schema(), other.song);
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder setSong(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder clearSong() {
      song = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder setArtist(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder clearArtist() {
      artist = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder setAction(Action value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public PlaySong.Builder clearAction() {
      action = null;
    ...
    public PlaySong build() {
      try {
        ...
        record.action = fieldSetFlags()[2] ? this.action : (Action) defaultValue(fields()[2]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.action = Action.values()[in.readEnum()];
